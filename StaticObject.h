...
public:
	...
	StaticObject(Mesh* mesh, Shader* shader, Material* mat, Vector3 position) : GameObject(mesh, shader, mat, position) {}
	StaticObject(Mesh* mesh, Shader* shader, Texture* texture, Material* mat) : GameObject(mesh, shader, texture, mat) {}
	StaticObject(Mesh* mesh, Shader* shader, Texture* texture, Material* mat, Vector3 position) : GameObject(mesh, shader, texture, mat, position) {}
